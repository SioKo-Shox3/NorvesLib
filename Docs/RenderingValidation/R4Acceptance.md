...
| R4-P7 | done。受入れ記録、指定CTest、独立評価を確定 |
...
| P4回帰の直接実行 | .harness/runs/20260922-r4-p7-final3/ddgi-probe-update-direct.log | EXIT_CODE=0。visibility-weighted one-bounce radiance 1.96391/0.981954/0.490977、unweighted 1.30247/0.651237/0.325619、hysteresis=0.6、VUID_COUNT=0 |
...
独立評価ログは `.harness/runs/20260922-r4-p7-final3/evaluator-R4-P7-round2.txt` に保存する。FramePacketの値所有、RenderThreadのlive World/SceneView参照禁止、Rendering層から RHI/Vulkan へのinclude禁止、LightingPassのDDGI fallback/atlas公開契約、診断バイパスの除去、R4成果物の追跡状態を確認対象とする。
