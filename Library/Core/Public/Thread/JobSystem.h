...
namespace NorvesLib::Thread
{
    ...
    public:
        ...
        enum ExecutionMode
        {
            EXECUTION_SIMPLE,       // 単純なグローバルキュー方式
            EXECUTION_WORK_STEALING // ワークスチーリング方式
        };
         ...
         */
        void Initialize(uint32_t threadCount = 0, ExecutionMode mode = ExecutionMode::EXECUTION_WORK_STEALING);
