...
namespace NorvesLib::Core::Rendering
{
    ...
    /**
     * @brief レンダリングリソースレジストリ
     *
     * RHIリソースやレンダリングリソースへの
     * ハンドルベースの公開アクセスを提供します。
     *
     * Game側からはこのクラスを通じてのみ
     * GPUリソースを作成・参照できます。
     *
    ...
    public:
         ...
         * GPUリソースのライフタイムはRenderResourceRegistryが管理するため、
    ...
    private:
        ...
        // プロシージャルメッシュGPUリソース
        Container::TUniquePtr<ProceduralMeshGpuStore> m_ProceduralMeshes;
