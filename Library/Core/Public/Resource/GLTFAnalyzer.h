...
namespace NorvesLib::Core::Resource
{
    ...
    public:
         ...
         * @param resourceRegistry Render resource registry used for GPU resources.
         ...
         * @param resourceRegistry Render resource registry used for final GPU creation.
         ...
         */
        static uint32_t FlushCompletedModelLoads(Rendering::RenderResourceRegistry& resourceRegistry,
