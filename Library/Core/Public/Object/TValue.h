...
namespace NorvesLib::Core
{
    ...
    // 特殊化による基本型マッピング
    template<> struct TypeToValueType<bool> { static constexpr IValue::ValueType value = IValue::ValueType::Bool; };
    template<> struct TypeToValueType<int8_t> { static constexpr IValue::ValueType value = IValue::ValueType::Int8; };
    template<> struct TypeToValueType<int16_t> { static constexpr IValue::ValueType value = IValue::ValueType::Int16; };
    template<> struct TypeToValueType<int32_t> { static constexpr IValue::ValueType value = IValue::ValueType::Int32; };
    template<> struct TypeToValueType<int64_t> { static constexpr IValue::ValueType value = IValue::ValueType::Int64; };
    template<> struct TypeToValueType<uint8_t> { static constexpr IValue::ValueType value = IValue::ValueType::UInt8; };
    template<> struct TypeToValueType<uint16_t> { static constexpr IValue::ValueType value = IValue::ValueType::UInt16; };
    template<> struct TypeToValueType<uint32_t> { static constexpr IValue::ValueType value = IValue::ValueType::UInt32; };
    template<> struct TypeToValueType<uint64_t> { static constexpr IValue::ValueType value = IValue::ValueType::UInt64; };
    template<> struct TypeToValueType<float> { static constexpr IValue::ValueType value = IValue::ValueType::Float; };
    template<> struct TypeToValueType<double> { static constexpr IValue::ValueType value = IValue::ValueType::Double; };
    template<> struct TypeToValueType<Container::String> { static constexpr IValue::ValueType value = IValue::ValueType::String; };
    template<> struct TypeToValueType<std::wstring> { static constexpr IValue::ValueType value = IValue::ValueType::WString; };
