...
namespace NorvesLib::Core::Rendering
{
    ...
    static_assert(offsetof(GPULightingParams, lightCount) == 644);
    static_assert(offsetof(GPULightingParams, bShadowEnabled) == 648);
    static_assert(offsetof(GPULightingParams, prefilteredSpecularMipLevels) == 652);
    static_assert(offsetof(GPULightingParams, bIBLEnabled) == 656);
    static_assert(offsetof(GPULightingParams, bSSAOEnabled) == 660);
