...
namespace NorvesLib::Core::Rendering
{
    ...
    void SceneView::CopyProxiesTo(SceneProxy& outScene) const
    {
        outScene.MeshProxies = m_MeshProxies;
        outScene.SkinnedMeshProxies = m_SkinnedMeshProxies;
        outScene.LightProxies = m_LightProxies;
        outScene.MegaGeometryProxies = m_MegaGeometryProxies;
    }
