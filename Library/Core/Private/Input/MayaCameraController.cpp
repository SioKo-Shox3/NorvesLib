...
namespace NorvesLib::Core::Input
{
    ...
    {
        (void)deltaTime; // マウスドラッグベースなので直接deltaTimeは使用しない（OnMouseMove/OnMouseScrollと同じ）
        ...
        // LMB: Orbit (Tumble)
        // OnMouseMove: Orbit() で m_Yaw -= deltaX*speed, m_Pitch -= deltaY*speed。
        ...
        // MMB: Pan (Track)
        // OnMouseMove: panAmount = m_PanSpeed*m_Distance、
        ...
        // RMB: Dolly
        // OnMouseMove: Dolly(-deltaX*m_DollySpeed*m_Distance)、Dolly() は m_Distance -= delta
        ...
        // スクロール: Dolly
        // OnMouseScroll: Dolly(scroll*m_ScrollDollySpeed*m_Distance) → m_Distance -= それ。
