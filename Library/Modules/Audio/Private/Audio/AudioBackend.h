...
namespace NorvesLib::Modules::Audio::Private
{
    ...
    public:
        ...
        /**
         * Success is a per-voice lifetime barrier: after returning, the backend
         * must not issue another callback for the handle or retain references to
         * its mailbox or submitted PCM bytes.
         */
