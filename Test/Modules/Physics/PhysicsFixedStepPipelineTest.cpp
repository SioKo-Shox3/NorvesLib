...
namespace
{
    ...
    static_assert(sizeof(FramePacketType) == 768);
    static_assert(alignof(FramePacketType) == 8);
    static_assert(sizeof(SceneProxyType) == 352);
    ...
    bool TestFramePacketBoundaryHasNoLivePhysicsPointers()
    {
        return !std::is_standard_layout_v<FramePacketType> && !std::is_standard_layout_v<SceneProxyType>
            && sizeof(FramePacketType) == 768 && alignof(FramePacketType) == 8
            && sizeof(SceneProxyType) == 352 && alignof(SceneProxyType) == 8;
    }
