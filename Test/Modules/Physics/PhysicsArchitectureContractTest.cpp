...
namespace
{
    ...
    static_assert(sizeof(Rendering::FramePacket) == 680);
    ...
    bool ViolatesPhysicsPrivateScope(const Container::String& source)
    {
        ...
        return HasForbiddenPhysicsFeature(code)
            ...
            || HasIdentifier(code, "RegisterReflectedTypes");
    }
    ...
    void TestArchitectureMutationPredicates()
    {
        ...
        const Container::String reflectionHook("void RegisterReflectedTypes() override;\n");
        ...
        const Container::String futurePrivateFile(
            "void SweepConvex();\n"
            "void RegisterReflectedTypes() override;\n");
        ...
        assert(HasIdentifier(StripCommentsAndLiterals(reflectionHook), "RegisterReflectedTypes"));
    ...
    void TestPhysicsScopeAndThreadGuards()
    {
        ...
        assert(!HasIdentifier(moduleCode, "RegisterClass"));
        assert(!HasIdentifier(moduleCode, "UnregisterClass"));
        assert(!HasIdentifier(moduleCode, "RegisterReflectedTypes"));
    ...
    void TestRenderingBoundaryHasNoLivePhysicsTypes()
    {
        const char* forbiddenIdentifiers[] =
        {
...
int main()
{
    ...
    TestRenderingBoundaryHasNoLivePhysicsTypes();
