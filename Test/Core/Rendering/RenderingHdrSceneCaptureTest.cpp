...
namespace
{
    ...
    private:
            ...
            Core::Container::String& reason)
        {
            ...
            R3RoiStatistics centerStatistics;
            R3RoiStatistics sideStatistics;
            if (!ComputeR3RoiStatistics(frame,
                                        centerMinX,
                                        centerMaxX,
                                        centerMinY,
                                        centerMaxY,
            ...
            const double fogCenterDelta =
                std::abs(m_R3FogOnlyCenterMean - centerMean);
            const double fogSideDelta =
                std::abs(m_R3FogOnlySideMean - sideMean);
            const bool bPassed =
